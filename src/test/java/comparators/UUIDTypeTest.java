...
public class UUIDTypeTest
{
    ...
    public int compareUsingJUG(UUID u1, UUID u2)
    {
        return (new org.safehaus.uuid.UUID(u1.toString()))
                .compareTo(new org.safehaus.uuid.UUID(u2.toString()));
    }
    ...
    public void testCompare(UUID u1, UUID u2, int expC)
    {
        ...
        // logger.info(describeCompare(u1, u2, c));
    ...
    {
        // a and b are two lexical UUIDs, a is clearly lexically less than
        // b. java.util.UUID.compareTo() will say the opposite because it
        // erroneously does a signed comparison.
        UUID a = UUID.fromString("20000000-0000-4000-8000-000000000000");
        UUID b = UUID.fromString("E0000000-0000-4000-8000-000000000000");
        // verify UUIDType compares them correctly
        assert uuidType.compare(bytebuffer(a), bytebuffer(b)) < 0;
        // verify java.util.UUID.compareTo() compares them incorrectly
